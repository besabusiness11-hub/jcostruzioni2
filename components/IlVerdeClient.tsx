...
export default function IlVerdeClient() {
  ...
  return (
    <main className="min-h-screen bg-[#fcfbf9]">
      <Header />
      <PageHero 
        title="Il Verde & Le Aree Esterne" 
      ...
      {(activeTab === "tutti" || activeTab === "terrazzi") && (
        <section id="terrazzi" className="py-24 lg:py-32 bg-background border-t border-slate-200/40">
          <div className="container mx-auto px-6 lg:px-12">
              ...
              <div className="order-2 lg:order-1 animate-fade-in-up">
                <div className="grid grid-cols-2 gap-6 relative">
                  ...
                  <div className="relative h-80 lg:h-96 rounded-[32px] overflow-hidden shadow-lg border border-slate-200/50 hover:shadow-2xl transition-all duration-700 mt-12 group hover:-translate-y-1">
                    <Image src="/images/outdoor-lounge.png" alt="Relax in terrazzo" fill className="object-cover transition-transform duration-1000 ease-out group-hover:scale-105" sizes="(max-width: 1024px) 50vw, 25vw" />
                    <div className="absolute bottom-4 left-4 bg-black/60 backdrop-blur-sm rounded-xl px-4 py-1.5">
      ...
      {(activeTab === "tutti" || activeTab === "giardini") && (
        <section id="giardini" className="py-24 lg:py-32 bg-gradient-to-b from-[#fbfbf9] to-[#f5f4ed] border-t border-slate-200/40">
          <div className="container mx-auto px-6 lg:px-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
      ...
      {(activeTab === "tutti" || activeTab === "parti-esterne") && (
        <section id="parti-esterne" className="py-24 lg:py-32 bg-background border-t border-slate-200/40">
          <div className="container mx-auto px-6 lg:px-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
      ...
      {(activeTab === "tutti" || activeTab === "piscina") && (
        <section id="piscina" className="py-24 lg:py-32 bg-gradient-to-b from-[#241a16] to-[#120d0b] text-white border-t border-white/10">
          <div className="container mx-auto px-6 lg:px-12">
            <div className="max-w-3xl mb-16 animate-fade-in-up">
              <span className="inline-block text-primary text-[10px] tracking-[0.4em] uppercase mb-4 font-bold">
                04 / Piscina Condominiale
              </span>
              <h2 className="font-serif text-4xl md:text-6xl text-white mb-6 font-medium leading-tight">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-16">
              <div className="lg:col-span-8 relative h-[450px] lg:h-[550px] rounded-[36px] overflow-hidden shadow-2xl border border-white/10 group">
      ...
      {/* CTA Section */}
      <section className="py-24 lg:py-32 bg-gradient-to-b from-[#fbfbf9] to-[#f5f4ed]">

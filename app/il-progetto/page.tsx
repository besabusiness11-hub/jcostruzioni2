        ...
        <div className="container mx-auto px-5 sm:px-6 lg:px-12">
          <div className="grid lg:grid-cols-2 gap-10 sm:gap-16 lg:gap-24 items-center">
            ...
            <div className="order-1 lg:order-2 animate-fade-in-up">
              ...
              <p className="text-muted-foreground/90 text-base sm:text-lg leading-relaxed font-light">
        ...
        <div className="container mx-auto px-5 sm:px-6 lg:px-12 text-center animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-4 sm:gap-6 justify-center items-center mt-12">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 w-full sm:w-auto px-5 sm:px-10 py-4 sm:py-5 bg-background text-foreground border border-slate-200 rounded-full text-xs font-bold tracking-[0.2em] uppercase transition-all duration-300 hover:bg-accent hover:border-slate-300 hover:-translate-y-1 shadow-sm"
            >
            ...
            <Link
              href="/contatti"
              className="inline-flex items-center justify-center w-full sm:w-auto px-5 sm:px-10 py-4 sm:py-5 bg-background text-foreground border border-slate-200 rounded-full text-xs font-bold tracking-[0.2em] uppercase transition-all duration-300 hover:bg-accent hover:border-slate-300 hover:-translate-y-1"
            >
              Prenota una Visita
            </Link>
          </div>
